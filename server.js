...
mongoose.connect(DB_URL, DB_Options)
    .then(() => console.log("Connected to HiveChat-MongoDB"))
...
const directMessagesRouter = require("./Routes/DirectMessages-Route");
...
app.use("/posts", authenticateRequest, postRouter);
app.use("/groups", authenticateRequest, groupRouter);
app.use("/messages", authenticateRequest, directMessagesRouter);
